...
def model_fit(model,train_batches,lr):
    model.layers.pop()
...
def get_predictions():
    path = 'C:\\Users\\U5752631\Desktop\\csproj17s2\\artefacts\\preprocessing\\create training and test datasets\\data\\PKlot\\'
    ...
    lr = 0.001
    model=model_fit(model,train_batches,lr)
    ...
    pathTofiles = 'C:\\Users\\U5752631\\Desktop\\csproj17s2\\artefacts\\preprocessing\\example_video\\img\\'
    ...
    for img_path in files:
        ...
        print(preds)
        if preds[0][1] == 1:
            dic[img_path.split('\\')[-1]] = 1
            print(dic[img_path.split('\\')[-1]])
        else:
            dic[img_path.split('\\')[-1]] = 0
            print(dic[img_path.split('\\')[-1]])
